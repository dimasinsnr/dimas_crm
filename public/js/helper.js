    ...
    return {
                ...
                $.ajax({
                    ...
                    complete: function (pages) {
                        ...
                        if (!isPopState) {
                            ...
                            var newMenu = (typeof menu != 'undefined') ? menu[0].toLowerCase() : '';
                            window.history.pushState({ 'menu_id': responseObject.menu_id }, responseObject.menu_title, newMenu);
                        }
                        // END PUSH STATE
        ...
        generateQR: function (config) {
            config = $.extend(true, {
                ...
                cornersSquareOptions: { "type": "extra-rounded", "color": "#016d00" },
